...
public class DragoEngine extends EngineBase {
    ...
    protected void localAttri() {
        ...
        parsLoc = GLES20.glGetUniformLocation(mProgram, "pars");
        checkLocation(parsLoc, "parameters ");
        lumLoc = GLES20.glGetUniformLocation(mProgram, "u_lum");
...
//        Log.d(TAG, "Drago apply");
        ...
        GLES20.glUniform4f(parsLoc, constant1, constant2, LMax, Lwa);
        ...
        GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
        GLES20.glBindTexture(GL_TEXTURE_EXTERNAL_OES, srcTextureId[0]);

        for (int i = 1; i < srcTextureId.length; ++i) {
            GLES20.glUniform1i(lumLoc, i);
            GLES20.glActiveTexture(GLES20.GL_TEXTURE0 + i);
            GLES20.glBindTexture(GL_TEXTURE_2D, srcTextureId[i]);
        }
