    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isAccessibilitySettingsOn("com.example.accessibility.WXAccessibilityService",
                        getApplicationContext())){
                    openAccessibility("com.example.accessibility.WXAccessibilityService",
                            getApplicationContext());
                }
            }
        });
        ...
        click.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e(TAG, "I hava been clicked ~");
                Toast.makeText(getApplicationContext(), "I hava been clicked ~~", Toast.LENGTH_LONG).show();
            }
        });
    }
